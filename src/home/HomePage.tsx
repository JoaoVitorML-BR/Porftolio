                            ...
                            <div className="row">
                                <div className="col">
                                    <div className='sticky-content pt-4'>
                                        <h1 className='textStyleGeneral'>João Vitor</h1>
                                        <h2 className='textStyleGeneral'> <img src={codeIcon} width={40} height={30} /> Desenvolvedor Web FullStack</h2>
                                        <p className='textStyleGeneral fw-light sm-bold'>Em 2018, descobri como os sites e aplicativos eram construidos e decidi começar a estudar sobre pelo YouTube.
                                ...
                                <div className="col-md-6 pt-4">
                                    ...
                                    <div className="scrollable">
                                        <div className='container-experiences'>
                                            <h4 className='textStyleGeneral fw-normal'>Prefeitura de Arapiraca/AL</h4>
                                            <h5 className='textStyleGeneral fw-light fs-5'>Desenvolvedor de automatizações Qgis</h5>
                                            <h6 className='textStyleGeneral fw-lighter fs-6'>03/2023 até o momento</h6>
                                            <p className='textStyleGeneral fw-light'>Desenvolvo sistemas automatizados no QGIS, utilizando PyQGIS e PostgreSQL. Também integro a API JavaScript/TypeScript do Google Maps em projetos específicos para expandir funcionalidades usando Node.JS e React.<br /></p>
                                        ...
                                        <div className='container-experiences'>
                                            <h4 className='textStyleGeneral fw-normal'>DIT - Núcleo de Desenvolvimento e Inovação Tecnológica - IFAL</h4>
                                            <h5 className='textStyleGeneral fw-light fs-5'>Desenvolvedor Backend - Golang (Voluntário)</h5>
                                            <h6 className='textStyleGeneral fw-lighter fs-6'>03/2023 até 03/2024</h6>
                                            <p className='textStyleGeneral fw-light'>Desenvolvedor trainee/junior em projeto de alto impacto para a cidade de arapiraca em parceria entre o Instituto federal de Alagoas e a Prefeitura de arapiraca, onde visou-se interligar as informações dos pacientes de hospitais públicos da cidade.<br /></p>
                                            <div className='tecnologies-style textStyleGeneral'>
                                        ...
                                        <div className='container-experiences'>
                                            <a href='https://tubeloadsave.vercel.app/' target="blank" className='link-no-underline'>
                                                <h4 className='textStyleGeneral fw-normal'>Baixador de vídeos e músicas do youtube</h4>
                                                <h5 className='textStyleGeneral fw-light fs-5'>Desenvolvedor FullStack</h5>
                                                <h6 className='textStyleGeneral fw-lighter'>06/2023 até 07/2023 </h6>
                                                <div className="image-container">
                                                    <img className='images-presentation' src={tubeLoadSaveImage} alt="Descrição da imagem" />
                                                    <div className="gradient-border"></div>
                                                </div>
                                                <p className='textStyleGeneral fw-light pt-1'>A ideia por trás deste projeto foi aprimorar minhas habilidades no consumo de APIs externas, então optei por criar um downloader para vídeos ou músicas do YouTube como forma de prática.<br /></p>
                                                <div className='tecnologies-style textStyleGeneral'>
                                                    <p className='fw-lighter paragath-style-tecnology'>React.js</p>
                                                    <p className='fw-lighter paragath-style-tecnology'>Node.js</p>
                                                    <p className='fw-lighter paragath-style-tecnology'>TypeScript</p>
                                        ...
                                        <div className='container-experiences'>
                                            <h4 className='textStyleGeneral fw-normal'>API - Login</h4>
                                            <h5 className='textStyleGeneral fw-light fs-5'>Desenvolvedor backend</h5>
                                            <h6 className='textStyleGeneral fw-lighter'>08/2023 até 09/2023</h6>
                                            <div className="image-container">
                                                <img className="images-presentation" src={golangImage} alt="Descrição da imagem" />
                                                <div className="gradient-border"></div>
                                            </div>
                                            <p className='textStyleGeneral fw-light pt-1'>Desenvolvi esse projeto pois estava precisando de uma API para permitir o login e cadastro dos itens no site iscompatible, logo, decidi fazer com go para fugir um pouco do node.js, foi de bastante aprendizado esse projeto pois nele pude aplicar conceitos da arquitetura hexagonal.<br /></p>
                                            <div className='tecnologies-style textStyleGeneral'>
                                                <p className='fw-lighter paragath-style-tecnology'>Golang</p>
                                                <p className='fw-lighter paragath-style-tecnology'>PostgreSQL</p>
